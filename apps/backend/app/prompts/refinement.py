...
CRITICAL RULES:
1. Do ADD skills, technologies, or certifications which are not in the master resume but necessary and relevant to the job description and job role
2. Rephrase existing bullet points to include keywords - only invent new content if necessary and relevant to the job role and job description
3. Maintain the exact same JSON structure
4. Do not use em-dashes (—) or their variants (---, --)
